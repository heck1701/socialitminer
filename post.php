...
<?php
	...
	$query = sprintf("SELECT Title, Body, User FROM Posts WHERE title='%s'",$PostTitle);
	...
	*/
	...
	echo '</tr>';
	echo '<tr>';
	echo '<td style="font-size:large;">UserName<td>';
	echo '</tr>';
	echo '<tr>';
	...
	echo '</tr>';
	echo '<tr>';
	echo '<td style="font-size:x-large;">.$row['User'].'<td>';
	echo '</tr>';
	echo '<tr>';
